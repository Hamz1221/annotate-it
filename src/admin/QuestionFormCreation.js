        ...
        <Segment basic>
            ...
            <br></br>
            {
                createdQuestions.map((question, index) => {
                    return (
                        <Segment key={index}>
                            <Input label="Question text"
                                value={question.question_text} fluid
                                icon='question'
                                placeholder='Enter question text here...'
                                onChange={event => updateQuestionText(event.target.value, index)} />
                            <Input label="Question category"
                                value={question.question_description}
                                icon='question'
                                placeholder='Enter question category here...'
                                onChange={event => updateQuestionCategory(event.target.value, index)} />
                            <Segment basic>
                                <Label>Options</Label>
                                {
